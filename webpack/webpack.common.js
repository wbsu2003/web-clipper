...
const distFiles = fs.existsSync(distPath) ? fs.readdirSync(distPath).filter((o) => o !== '.gitkeep') : [];
...
module.exports = {
  ...
  module: {
    rules: [
      ...
      {
        test: /\.less$/,
        include: [/node_modules[\\/]antd/, /node_modules[\\/]@ant-design/, /node_modules[\\/]@formily/],
        use: [
          {
            loader: 'style-loader',
          },
